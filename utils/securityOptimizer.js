...
class SecurityOptimizer {
    constructor() {
        this.securityConfig = {
            ...
            securityHeaders: {
                csp: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://cdn.socket.io https://cdn.jsdelivr.net https://connect.facebook.net https://static.cloudflareinsights.com https://cdn.tailwindcss.com https://unpkg.com; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://fonts.googleapis.com https://cdn.tailwindcss.com https://unpkg.com; img-src 'self' data: https: http://localhost:* http://127.0.0.1:*; font-src 'self' https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://fonts.googleapis.com https://fonts.gstatic.com; connect-src 'self' https://opay.mucamba.site https://fonts.googleapis.com https://api.utmify.com.br https://api.utmify.com https://cdn.socket.io wss://cdn.socket.io wss://ratixpay.site ws://ratixpay.site ws://localhost:* http://localhost:* wss://localhost:* https://connect.facebook.net https://www.facebook.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://static.cloudflareinsights.com https://cdn.tailwindcss.com https://unpkg.com; frame-src 'self' https://www.youtube.com https://youtube.com https://www.youtu.be https://youtu.be https://player.vimeo.com https://vimeo.com https://www.vimeo.com https://embed.videodelivery.net https://*.cloudinary.com https://*.cloudflare.com https://scripts.converteai.net https://*.converteai.net blob:; worker-src 'self' blob:;",
